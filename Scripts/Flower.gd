...
func _on_main_upgrade_timer_timeout():
	if upgrade_times <= 4:
		Global.Flower_damage = int(Global.Flower_damage * 1.05)
		Flower_max_health = int(Flower_max_health * 1.1)
		Flower_EXP_cost = int(Flower_EXP_cost * 1.25)
		Flower_left_gold += 1
		Flower_right_gold += 1
	elif upgrade_times > 4 and upgrade_times <= 10:
		Global.Flower_damage = int(Global.Flower_damage * 1.1)
		...
		Global.Flower_damage = int(Global.Flower_damage * 1.14)
		Flower_max_health = int(Flower_max_health * 1.19)
		Flower_EXP_cost = int(Flower_EXP_cost * 1.7)
		Flower_left_gold += 5
		Flower_right_gold += 5
	elif upgrade_times > 20:
		Global.Flower_damage = int(Global.Flower_damage * 1.25)
		Flower_max_health = int(Flower_max_health * 1.3)
		Flower_EXP_cost = int(Flower_EXP_cost * 2.2)
		Flower_left_gold += 12
		Flower_right_gold += 12
	upgrade_times += 1
