...
func _on_main_upgrade_timer_timeout():
	if upgrade_times <= 4:
		...
		Hameleon_max_health = int(Hameleon_max_health * 1.2)
		Hameleon_speed = int(Hameleon_speed * 1.15)
		Hameleon_EXP_cost = int(Hameleon_EXP_cost * 1.4)
		...
		Hameleon_max_health = int(Hameleon_max_health * 1.3)
		Hameleon_speed = int(Hameleon_speed * 1.3)
		Hameleon_EXP_cost = int(Hameleon_EXP_cost * 1.7)
		...
		Hameleon_EXP_cost = int(Hameleon_EXP_cost * 2)
		Hameleon_left_gold += 11
		Hameleon_right_gold += 11
	upgrade_times += 1
